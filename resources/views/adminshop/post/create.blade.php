                  ...
                  <div class="card card-danger">
                    ...
                    <div class="card-body">
                      @foreach($postcategories as $postcategory)
                        <input type="checkbox" name="postcate[]" value="{{$postcategory->id}}"> {{$postcategory->name}}<br/>
                      @endforeach
                    </div>
                    <!-- /.card-body -->
                  </div>
                  ...
                  <div class="card card-primary">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="posterName" class="form-control" placeholder="Enter Postername">
                      </div>
                      <div class="form-group">
                          <label>Content</label>
                          <textarea name="content" class="form-control my-editor" rows="4">{{old('content')}}</textarea>
                      </div>
                    </div>
                    <!-- /.card-body -->
                  </div>
