                        ...
                        <td>
                          <div class="btn-group">
                            <abbr title="Sửa dữ liệu">
                              <a href="{{ route('adminshop.post.category.editCategory', $postcategory['id'])}}">
                            ...
                            <abbr title="Xóa dữ liệu">
                              <a onclick="return confirm('Do you want to delete this postcategory?')" href="{{ route('adminshop.post.category.deleteCategory', $postcategory['id'])}}">
