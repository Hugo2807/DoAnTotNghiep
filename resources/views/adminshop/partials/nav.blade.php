<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    {{-- <a href="index3.html" class="brand-link" style="text-align: center">
      <img src="dashboard/dist/img/Logo-01.png" alt="Vinfruts Logo" width="150px" height="60px">
    </a> --}}
    <a href="{{ route('adminshop.index') }}" class="brand-link">
      <img src="dashboard/dist/img/Vin.jpg" alt="Vinfruts Logo" class="brand-image img-circle elevation-3 mr-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      {{-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="image">
          <img src="dashboard/dist/img/anhdaidien.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Trần Văn Huy</a>
        </div>
      </div> --}}
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <div class="nav-link">
                    <i class="fas fa-paste ml-3 mr-2"></i>
                ...
                <li class="nav-item">
                  <a href="{{ route('adminshop.comment.index') }}" class="nav-link">
                    <i class="fas fa-comments nav-icon ml-2"></i>
                    <p>Quản lý bình luận</p>
                  </a>
                </li>
                <li class="nav-item">
                  <div class="nav-link">
                    <i class="fab fa-product-hunt ml-3 mr-2" style="content: '\f104';"></i>
                ...
                <li class="nav-item">
                  <a href="{{ route('adminshop.slider.index') }}" class="nav-link">
                    <i class="fa fa-fw fa-sliders nav-icon ml-2"></i>
                    <p>Quản lý Slider</p>
                  </a>
                </li>
                <li class="nav-item">
